...
description: 维护 meta-kit 内远程来源 skill 的登记与更新流程。触发场景：更新或检查 meta-kit skill、查看远程来源、添加/删除登记项。关键词：meta-kit update、remote skill、Git source、skill registry。
---

# meta-kit-update

使用本 skill 让 meta-kit 内有远程来源的 skills 保持可复现。它记录每个 skill 的名称、远程来源、本地路径、预期更新方式和本地 overlay。
...
只有当用户明确要求把某个新 skill 加入 meta-kit 远程来源登记表时，才新增登记项。新增时记录：
