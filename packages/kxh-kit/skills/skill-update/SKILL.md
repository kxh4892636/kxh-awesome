...
# 检查 <tmp-dir>，将其与 packages/kxh-kit/skills/<skill-name> 比较，然后有意识地同步。
```
...
2. 检查 `packages/kxh-kit/skills/code-spec/SKILL.md` 中的嵌入式 guidance 章节。
